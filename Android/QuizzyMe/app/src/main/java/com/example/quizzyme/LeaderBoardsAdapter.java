...
import com.example.quizzyme.databinding.RowLeaderboardsBinding;


import java.util.ArrayList;

class LeaderboardsAdapter extends RecyclerView.Adapter<LeaderboardsAdapter.LeaderboardViewHolder> {
